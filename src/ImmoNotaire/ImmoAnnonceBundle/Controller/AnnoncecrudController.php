...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $annonces = $em->getRepository('ImmoAnnonceBundle:Annonce')->findAll();
    ...
    {
        $annonce = new Annonce();
        $form = $this->createForm('ImmoNotaire\ImmoAnnonceBundle\Form\AnnonceType', $annonce);
    ...
    {
        $deleteForm = $this->createDeleteForm($annonce);
        $editForm = $this->createForm('ImmoNotaire\ImmoAnnonceBundle\Form\AnnonceType', $annonce);
