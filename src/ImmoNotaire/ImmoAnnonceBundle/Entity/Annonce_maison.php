 ...
 * Annonce_maison
 *
 * @ORM\Table(name="annonce_maison")
 * @ORM\Entity(repositoryClass="ImmoNotaire\ImmoAnnonceBundle\Repository\Annonce_maisonRepository")
 */
class Annonce_maison
{
    /**
     * @var int
     *
    ...
    private $id;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="ImmoNotaire\ImmoNotaireBundle\Entity\User", inversedBy="annonce_maison")
     */
    private $user;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ImmoNotaire\ImmoAnnonceBundle\Entity\Type_maison",cascade={"persist","remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $type_maison;
     ...
     * Set typeMaison
     *
     * @param \ImmoNotaire\ImmoAnnonceBundle\Entity\Type_maison $typeMaison
     *
     * @return Annonce_maison
     */
    public function setTypeMaison(\ImmoNotaire\ImmoAnnonceBundle\Entity\Type_maison $typeMaison)
    {
     ...
     * Get typeMaison
     *
     * @return \ImmoNotaire\ImmoAnnonceBundle\Entity\Type_maison
     */
