...
/**
 * Annonce_terrainRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class Annonce_terrainRepository extends \Doctrine\ORM\EntityRepository {

    
    public function rechercheTerrain(array $param) {
        ...
        if (!empty($param['type_biens'])) {
         ...
         if (!empty($param['type_terrain'])) {
            $query->andWhere($query->expr()->orX($query->expr()->eq('a.type_terrain', ':typeTerrain')))
                    ->setParameter('typeTerrain', $param['type_terrain']); //appart ou autre
        }
