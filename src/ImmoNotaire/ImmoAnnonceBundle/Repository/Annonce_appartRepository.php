...
/**
 * Annonce_appartRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class Annonce_appartRepository extends \Doctrine\ORM\EntityRepository {

    public function rechercheAppart(array $param) {
        ...
        if (!empty($param['type_biens'])) {
         ...
         if (!empty($param['type_appart'])) {
            $query->andWhere($query->expr()->orX($query->expr()->eq('a.type_appart', ':typeAppart')))
                    ->setParameter('typeAppart', $param['type_appart']); //appart ou autre
        }
